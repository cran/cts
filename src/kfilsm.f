...
C     STORE FILTERED AND SMOOTHED VALUES, TOGETHER WITH ORIGINAL DATA
      OPEN(UNIT=4,FILE='filser.dat',STATUS='unknown')
      WRITE(4,195)
...
c  201 FORMAT(54H  TIME SERIES FILSER FILVAR ERROR ERRVAR SMOSER SMOVAR)
  201 FORMAT(68H  TIME SERIES FILSER FILVAR ERROR ERRVAR SMOSER SMOVAR I
     +NNSER STDINN)
      DO 20 T=1,LEN
      WRITE(4,202) TIM(T),SER(T),FSER(T),FVAR(T)
      WRITE(4,202) PRE(T),PRV(T),SSER(T),SVAR(T)
   20 write(4,202) err(T),sres(T)
  202 FORMAT(4E13.5)
      CLOSE(UNIT=4)
      OPEN(UNIT=4,FILE='fsest.dat',STATUS='unknown')
      WRITE(4,295)
  295 FORMAT(18H  DIMENSION LENGTH )
      WRITE(4,296) ARP,LEN
  296 FORMAT(2I10)
      WRITE(4,300)
  300 FORMAT(20H  OBSERVATION VECTOR  )
      WRITE(4,302) (XVECR(I),I=1,ARP)
      WRITE(4,301)
  301 FORMAT(35H  FILSTATE SMOOSTATE FILVAR SMOOVAR  )
      DO 30 T=1,LEN
      WRITE(4,302) (FSES(T,I),I=1,ARP)
      WRITE(4,302) (SSES(T,I),I=1,ARP)
      WRITE(4,302) (FSCV(T,I,I),I=1,ARP)
   30 WRITE(4,302) (SSCV(T,I,I),I=1,ARP)
  302 FORMAT(4E13.5)
      CLOSE(UNIT=4)
      RETURN
      END
